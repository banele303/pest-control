...
export default function Footer() {
        ...
        <div className="bg-black ">
            <footer className="footer p-10 grid grid-cols-1 md:grid-cols-4 gap-5">
                <aside className="flex flex-row gap-[-1rem]">
                    <div className="md:mt-[-2rem] pr-[-2rem] text-white"></div>
             ...
             <Image src="/logo/main-logo.png" alt="logo" className="py-[1rem] absolute w-[5rem] md:w-[9rem] h-[7rem] md:h-[10rem]" width={200} height={50} />
                ...
                <nav className="flex flex-col">
                    <h6 className="footer-title text-semibold text-slate-200 text-[17px] ">Eco Pest Control</h6>
                    
                    <p className="link link-hover text-slate-400"><Link href="/">Home</Link> </p>
                    <p className="link link-hover text-slate-400"><Link href="/services">Services</Link> </p>
                    <p className="link link-hover text-slate-400"><Link href="/our-plumbing-services">Contact</Link> </p>
  ...
  <aside className="items-center grid-flow-col">
    ...
    <p className="text-slate-200 mr-3 md:pl-[4rem]">Build and created by <span className="text-blue-600"> <Link href='/southflowagency.co.za'>SouthFlow Marketing Agency</Link></span> Alex © 2024 - All right reserved</p>
  </aside> 
